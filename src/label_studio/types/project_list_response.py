...
class Result(BaseModel):
    ...
    allow_stream: Optional[str] = None
    ...
    num_tasks_with_annotations: Optional[str] = None
    ...
    review_total_tasks: Optional[str] = None

    reviewed_number: Optional[str] = None
    ...
    skipped_annotations_number: Optional[str] = None
    ...
    total_annotations_number: Optional[str] = None
