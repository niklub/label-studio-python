...
from ....types.dataset_storages.gcs import column_list_params
...
class ColumnsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            f"/api/dataset-storages/gcs/{id}/columns/",
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"ordering": ordering}, column_list_params.ColumnListParams),
            ),
            cast_to=NoneType,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"ordering": ordering}, column_list_params.ColumnListParams),
            ),
            cast_to=NoneType,
        )
