...
class TestS3:
    ...
    def test_raw_response_create(self, client: LabelStudio) -> None:
        response = client.dataset_storages.s3.with_raw_response.create(
            dataset=0,
        )
    ...
    def test_streaming_response_create(self, client: LabelStudio) -> None:
        with client.dataset_storages.s3.with_streaming_response.create(
            dataset=0,
        ) as response:
    ...
    def test_method_retrieve(self, client: LabelStudio) -> None:
        s3 = client.dataset_storages.s3.retrieve(
            0,
        )
        assert_matches_type(S3DatasetStorage, s3, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: LabelStudio) -> None:
        response = client.dataset_storages.s3.with_raw_response.retrieve(
            0,
        )
    ...
    def test_streaming_response_retrieve(self, client: LabelStudio) -> None:
        with client.dataset_storages.s3.with_streaming_response.retrieve(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_raw_response_list(self, client: LabelStudio) -> None:
        response = client.dataset_storages.s3.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: LabelStudio) -> None:
        with client.dataset_storages.s3.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_delete(self, client: LabelStudio) -> None:
        s3 = client.dataset_storages.s3.delete(
            0,
        )
        assert s3 is None
    ...
    def test_raw_response_delete(self, client: LabelStudio) -> None:
        response = client.dataset_storages.s3.with_raw_response.delete(
            0,
        )
    ...
    def test_streaming_response_delete(self, client: LabelStudio) -> None:
        with client.dataset_storages.s3.with_streaming_response.delete(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_raw_response_check_for_records(self, client: LabelStudio) -> None:
        response = client.dataset_storages.s3.with_raw_response.check_for_records(
            dataset=0,
        )
    ...
    def test_streaming_response_check_for_records(self, client: LabelStudio) -> None:
        with client.dataset_storages.s3.with_streaming_response.check_for_records(
            dataset=0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_raw_response_validate(self, client: LabelStudio) -> None:
        response = client.dataset_storages.s3.with_raw_response.validate(
            dataset=0,
        )
    ...
    def test_streaming_response_validate(self, client: LabelStudio) -> None:
        with client.dataset_storages.s3.with_streaming_response.validate(
            dataset=0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncS3:
    ...
    async def test_raw_response_create(self, async_client: AsyncLabelStudio) -> None:
        response = await async_client.dataset_storages.s3.with_raw_response.create(
            dataset=0,
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        s3 = await response.parse()
        assert_matches_type(S3DatasetStorage, s3, path=["response"])

    @parametrize
    async def test_streaming_response_create(self, async_client: AsyncLabelStudio) -> None:
        async with async_client.dataset_storages.s3.with_streaming_response.create(
            dataset=0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_retrieve(self, async_client: AsyncLabelStudio) -> None:
        s3 = await async_client.dataset_storages.s3.retrieve(
            0,
        )
        assert_matches_type(S3DatasetStorage, s3, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncLabelStudio) -> None:
        response = await async_client.dataset_storages.s3.with_raw_response.retrieve(
            0,
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncLabelStudio) -> None:
        async with async_client.dataset_storages.s3.with_streaming_response.retrieve(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_list(self, async_client: AsyncLabelStudio) -> None:
        response = await async_client.dataset_storages.s3.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncLabelStudio) -> None:
        async with async_client.dataset_storages.s3.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncLabelStudio) -> None:
        s3 = await async_client.dataset_storages.s3.delete(
            0,
        )
        assert s3 is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncLabelStudio) -> None:
        response = await async_client.dataset_storages.s3.with_raw_response.delete(
            0,
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncLabelStudio) -> None:
        async with async_client.dataset_storages.s3.with_streaming_response.delete(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_check_for_records(self, async_client: AsyncLabelStudio) -> None:
        response = await async_client.dataset_storages.s3.with_raw_response.check_for_records(
            dataset=0,
        )
    ...
    async def test_streaming_response_check_for_records(self, async_client: AsyncLabelStudio) -> None:
        async with async_client.dataset_storages.s3.with_streaming_response.check_for_records(
            dataset=0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_validate(self, async_client: AsyncLabelStudio) -> None:
        response = await async_client.dataset_storages.s3.with_raw_response.validate(
            dataset=0,
        )
    ...
    async def test_streaming_response_validate(self, async_client: AsyncLabelStudio) -> None:
        async with async_client.dataset_storages.s3.with_streaming_response.validate(
            dataset=0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
