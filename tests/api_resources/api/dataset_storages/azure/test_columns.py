...
class TestColumns:
    ...
    def test_method_list(self, client: LabelStudio) -> None:
        column = client.api.dataset_storages.azure.columns.list(
            0,
        )
    ...
    def test_raw_response_list(self, client: LabelStudio) -> None:
        response = client.api.dataset_storages.azure.columns.with_raw_response.list(
            0,
        )
    ...
    def test_streaming_response_list(self, client: LabelStudio) -> None:
        with client.api.dataset_storages.azure.columns.with_streaming_response.list(
            0,
        ) as response:
...
class TestAsyncColumns:
    ...
    async def test_method_list(self, async_client: AsyncLabelStudio) -> None:
        column = await async_client.api.dataset_storages.azure.columns.list(
            0,
        )
        assert column is None
    ...
    async def test_raw_response_list(self, async_client: AsyncLabelStudio) -> None:
        response = await async_client.api.dataset_storages.azure.columns.with_raw_response.list(
            0,
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncLabelStudio) -> None:
        async with async_client.api.dataset_storages.azure.columns.with_streaming_response.list(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
