...
from label_studio._types import Omit
...
class TestLabelStudio:
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(LabelStudioError):
            with update_env(**{"LABEL_STUDIO_TOKEN": Omit()}):
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/api/comments/").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        self, client: LabelStudio, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.comments.with_raw_response.create(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.comments.with_raw_response.create(extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncLabelStudio:
    ...
    async def test_retries_taken(
        ...
        response = await client.comments.with_raw_response.create()
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncLabelStudio, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.comments.with_raw_response.create(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.comments.with_raw_response.create(extra_headers={"x-stainless-retry-count": "42"})
    ...
    def test_get_platform(self) -> None:
        ...
        from label_studio._utils import asyncify
        from label_studio._base_client import get_platform 
